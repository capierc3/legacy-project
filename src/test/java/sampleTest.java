...
import main.java.memoranda.ui.htmleditor.filechooser.*;
...
public class sampleTest {
	...
	// Variable 1;
	// Variable 2;
    CalendarDate tempDate = new CalendarDate();
    ...
    public void defaultTax()  {
        double amount = normalCart.getTax(normalCartSubtotal, "XX");
    ...
    public void removeItemTest() {
        ...
        assertTrue(removeTest);

    @Test
    public void removeItemTestFalse() {
    	// Item in cart should be dairy, this will show as produce and return false
    ...
    public void nodeAndEdge2() throws UnderAgeException {
        double amount = underageCart.calcCost();
