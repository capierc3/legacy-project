 ...
 *
 * BlackBox notes: All main methods should work that are found in the GymClass
 * interface. Currently as of 4/11 the add/get students and add/get trainers
 * don't work since those codes are not available yet. also get and set room
 * don't work for the same reason. Static Analysis done by Justin. Blackbox and
 * Whitebox testing done in Task76Test.java
 *
...
public class GymClassImpl implements GymClass {
    ...
    /**
     * Constructor with only name and type, ideally used for personal training
     * spots.
     * 
     * @param name String
     * @param type String
    ...
    /**
     * Constructor with a name, type and rank, ideally used for the gym classes that
     * need a rank.
     * 
     * @param name String
     * @param type String
