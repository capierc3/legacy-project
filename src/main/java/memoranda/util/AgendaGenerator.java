...
public class AgendaGenerator {
    ...
    /**
     * Method to generate details for Task based on Project, CalendarDate and
     * Collection of Tasks passed in
     * 
     * @param p
     * @param date
     * @param expandedTasks
	...
	s += "<a name=\"" + t.getID() + "\"><li><p>" + subTaskOperation + "<a href=\"kaesekuchen:tasks#" + p.getID()
    ...
    /**
     * Method to return an int value based on the Progress of Tasks in the TaskList
     * passed in
     * 
     * @param tl
     * @return int
    ...
    /**
     * Method to return a String with the Task's Priority Status, and uses Local
     * settings to determine color of the font
     * 
     * @param p
     * @return String
     */
	...
	String s = "<h2><a href=\"kaesekuchen:project#" + p.getID() + "\">" + p.getTitle() + "</a></h2>\n"
	...
	String s = "<td width=\"66%\" valign=\"top\">" + "<h1>" + Local.getString("Belt goals") + "</h1>\n";
    ...
    /**
     * Method to generate Events information for a CalenderDate passed in TODO
     * figure out how to access notes by date from a static context
     * 
     * @param date CalendarDate
     * @return String
     */
    static String generateEventsInfo(CalendarDate date) {
	String s = "<td width=\"34%\" valign=\"top\">" + "<a href=\"kaesekuchen:events\"><h1>"
		+ Local.getString("Events") + "</h1></a>\n"
    ...
    /**
     * Method to generate Stickers table for CalendarDate date passed in. The
     * stickers are displayed by the sorting from the PriorityQueue
     * 
     * @param date
     * @return
     */
	...
	String s = "<hr><hr><table border=\"0\" cellpadding=\"0\" width=\"100%\"><tr><td><a href=\"kaesekuchen:importstickers\"><b>"
		+ Local.getString("Import sticker") + "</b></a></td><td><a href=\"kaesekuchen:exportstickerst\"><b>"
		+ Local.getString("Export as text file") + "</b></a><td><a href=\"kaesekuchen:exportstickersh\"><b>"
		+ Local.getString("Export as html page") + "</b></a></td></tr></table>"
	...
	while (!pQ.Empty()) {
	    ...
	    s += "\n<table border=\"0\" cellpadding=\"0\" width=\"100%\"><table width=\"100%\"><tr bgcolor=\"#E0E0E0\"><td><a href=\"kaesekuchen:editsticker#"
		    + id + "\">" + Local.getString("EDIT")
		    + "</a></td><td width=\"70%\"><a href=\"kaesekuchen:expandsticker#" + id + "\">"
		    + Local.getString("OPEN IN A NEW WINDOW") + "</></td><td align=\"right\">" + "&nbsp;" + // without
													    ...
													    // whole
													    // cell
		    "<a href=\"kaesekuchen:removesticker#" + id
    ...
    /**
     * Method to sort the Stickers by their priority and returns a PriorityQueue
     * object
     * 
	...
	ret = txt.substring(0, first + 1) + "<a href=\"kaesekuchen:expandsticker#" + id + "\">"
	...
	int first = txt.indexOf(">");
	int last = txt.lastIndexOf("<");
	ret = txt.substring(0, first + 1) + "<a href=\"kaesekuchen:editsticker#" + id + "\">"
		+ txt.substring(first + 1, last) + "</a>" + txt.substring(last);
	return ret;
    }

    /**
     * Method to get the Agenda based on CalendarDate passed in along with a
     * Collection of expandedTasks tied to the Projects
     * 
     * @param date
     * @param expandedTasks
     * @return String
