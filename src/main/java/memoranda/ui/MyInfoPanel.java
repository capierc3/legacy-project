/* 
 * This class is designed to display a panel and show the appropriate info when the My Info button is clicked. It used the agenda panel as an original Source
 * 
 * 
 * 
 */
