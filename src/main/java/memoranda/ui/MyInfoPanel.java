/** 
 * This class is designed to display a panel and show 
 * appropriate info when the My Info button is clicked. 
 */
...
public class MyInfoPanel extends JPanel {
    ...
    public MyInfoPanel(DailyItemsPanel _parentPanel) {
	try {
	...
	viewer.addHyperlinkListener(new HyperlinkListener() {
		...
		if (e.getEventType() == HyperlinkEvent.EventType.ACTIVATED) {
			...
			String name = JOptionPane.showInputDialog(parent,
				Local.getString("Enter name of file to export"), null);
			...
			final JFrame parent = new JFrame();
			String name = JOptionPane.showInputDialog(parent,
				Local.getString("Enter name of file to import"), null);
