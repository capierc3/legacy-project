...
public class TaskTable extends JTable {
	...
	/**
	 * Subclassed to translate the graphics such that the last visible row will be
	 * drawn at 0,0.
	 */
	 ...
	 * <p>
	 * If model has been changed (eg. project change) we still try to expand paths
	 * whick do not exist. We just assume that this is not causing problems, and as
	 * a side effect it preserved tree expansion status even after project has been
	 * changed to some other project and then back.
	 * </p>
	 * <p>
	 * It is possible that there will be memory leak if expanded paths have been
	 * removed from model, but effect of this is quite insignificant.
	 * </p>
	 */
