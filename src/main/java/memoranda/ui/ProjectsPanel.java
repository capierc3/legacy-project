...
public class ProjectsPanel extends JPanel implements ExpandablePanel {
    ...
    public Action newProjectAction = new AbstractAction(Local.getString("New project") + "...",
	    new ImageIcon(main.java.memoranda.ui.AppFrame.class.getResource("/ui/icons/newproject.png"))) {
	...
	/*
	 * buttonsPanel.add(newProjectB, null); buttonsPanel.add(editProjectB, null);
	 */
	...
	ppProperties
		.setIcon(new ImageIcon(main.java.memoranda.ui.AppFrame.class.getResource("/ui/icons/editproject.png")));
	...
	ppDeleteProject.setIcon(
		new ImageIcon(main.java.memoranda.ui.AppFrame.class.getResource("/ui/icons/removeproject.png")));
	...
	ppOpenB.setIcon(new ImageIcon(main.java.memoranda.ui.AppFrame.class.getResource("/ui/icons/ppopen.png")));
	...
	for (int i = 0; i < prjTablePanel.projectsTable.getSelectedRows().length; i++) {
	    prj = (main.java.memoranda.Project) prjTablePanel.projectsTable.getModel()
