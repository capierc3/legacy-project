...
public class ExitConfirmationDialog extends JDialog implements WindowListener {
	...
	header.setIcon(new ImageIcon(main.java.memoranda.ui.ClassDialog.class.getResource("/ui/icons/exit.png")));
	headerPanel.add(header);

	// Build mainPanel
	JLabel confirm = new JLabel();
	confirm.setText("<HTML>" + Local.getString("This action will cause Kaesekuchen to exit") + "<p>"
