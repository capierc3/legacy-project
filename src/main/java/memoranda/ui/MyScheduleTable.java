...
public class MyScheduleTable extends JTable {
	...
	String[] columnNames = { Local.getString("Name"), Local.getString("Class Type"), Local.getString("Belt Needed"),
		Local.getString("Start Time"), Local.getString("Class Length"), Local.getString("Instructor"),
