...
//        border7 = BorderFactory.createLineBorder(Color.white, 2);
	...
	setNotifB.setIcon(new ImageIcon(main.java.memoranda.ui.AppFrame.class.getResource("/ui/icons/notify.png")));
...
//    	((AppFrame)App.getFrame()).workPanel.dailyItemsPanel.schedulePanel.newEventB_actionPerformed(e,
