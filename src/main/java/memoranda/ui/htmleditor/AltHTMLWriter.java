...
public class AltHTMLWriter extends AbstractWriter {
    ...
    class OptionListModel extends DefaultListModel implements Serializable, ListSelectionModel {
	 ...
	 * @exception CloneNotSupportedException if the receiver does not both (a)
	 *                                       implement the <code>Cloneable</code>
	 *                                       interface and (b) define a
