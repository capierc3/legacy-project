...
/**
 * Creates an individual trainer "card" that displays information about the
 * trainer Will be displayed in TrainerProfilesPanel
 * 
...
public class TrainerCardPanel extends JPanel {
    ...
    /**
     * Initializes the code html tag is used in Jlabel to allow text to wrap
     *
     * @throws Exception
     */
    ...
    /**
     * Method to add edit this users card Removes all items first so that when it
     * revalidates they display in the correct order repaint to clear old data and
     * revalidate to display new
     * 
