...
public class EventsManager {
    ...
    // year, month, and day class just like Notes has. Should just turn into its own
    // classes.
	...
	/**
	 * Method that creates and returns a Month created based on the int m passed in
	 * and ties to current Year
	 * 
	 * @param m
	 * @return Month
	 */
	...
	/**
	 * Method that returns the Day tied to the current Month based on the int d
	 * value for the Day
	 * 
	 * @param d
	 * @return Day
