...
public class NoteListImpl implements NoteList {
    ...
    /**
     * @see main.java.memoranda.NoteList#getNotesForPeriod(CalendarDate,
     *      CalendarDate)
...
//		CurrentNote.set(null);
	...
	/**
	 * creates a Month object and stores in the yearElement, also returns the Month
	 * object
	 * 
	 * @param m int
	 * @return Month
	...
	/**
	 * <<<<<<< HEAD getter for the int value of the Day ======= Method that returns
	 * the int value of the current Day >>>>>>> US_44/comments-to-util-package
	 * 
	 * @return int
	 */
	public int getValue() {
	...
	/**
	 * <<<<<<< HEAD Returns the note stored in the element
	 * 
	 * @param d String ======= Method that gets and returns the NoteElement from the
	 *          current day based on String d passed in
	 * @param d >>>>>>> US_44/comments-to-util-package
	 * @return NoteElement
	 */
	...
	/**
	 * <<<<<<< HEAD Creates a note element and adds it to the day
	 * 
	 * @param d String ======= Method that creates and returns a NoteElement from
	 *          String d passed in
	 * @param d >>>>>>> US_44/comments-to-util-package
	 * @return NoteElement
	 */
...
//			el.addAttribute(new Attribute("refid", d));
	...
	/**
	 * <<<<<<< HEAD Getter that returns a vector of all the notes stored in the day
	...
	/**
	 * <<<<<<< HEAD getter that returns the main element used in the class =======
